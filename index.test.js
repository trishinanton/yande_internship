const callbackyWinners = require("./index");
const STREET_RACERS = ["Brian", "Mia", "Han", "Gisele", "Dominic"];
// const STREET_RACERS = ["Gisele","Dominic","Brian"];
...
function createTestRace(sequence) {     //sequence - последовательнсть
  const registeredEventHandlers = {};  //зарегистрированные обработчики событий
  ...
  function addEventListener(eventType, callback, options) {
    const subscription = { callback, options }; //подписка
